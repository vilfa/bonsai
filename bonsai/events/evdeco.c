...
void
bsi_server_decoration_destroy_notify(struct wl_listener* listener, void* data)
{
    ...
    bsi_server_decoration_finish(server_deco);
    bsi_server_decoration_destroy(server_deco);
}

void
bsi_server_decoration_mode_notify(struct wl_listener* listener, void* data)
{
